...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-x16l(xy6r)11w-h8_4(k4m^1uo8^*v38)w61tb2#3hiq5kuy8+')
...
# CORS - Allow all in production for hackathon
...
# Also load from parent .env (for local development)
